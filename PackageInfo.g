...
Persons := [
  rec( 
    ...
    IsAuthor      := true,
    IsMaintainer  := true,
    Email         := "bamberg@cage.ugent.be",
    WWWHome       := "http://cage.ugent.be/~bamberg",
  ...
  rec( 
    ...
    WWWHome       := "https://www.maths.uwa.edu.au/Members/maska",
    PostalAddress := Concatenation( [
                       "Maska Law\n",
  ...
  rec( 
    ...
    IsAuthor      := true,
    IsMaintainer  := true,
    Email         := "pauley@maths.uwa.edu.au",
    WWWHome       := "https://www.maths.uwa.edu.au/Members/pauley",
    PostalAddress := Concatenation( [
                       "Michael Pauley\n",
                       "School of Mathematics and Statistics\n",
                       "The University of Western Australia\n",
  ...
  rec( 
    ...
    IsAuthor      := true,
    IsMaintainer  := true,
    Email         := "reichard@maths.uwa.edu.au",
    WWWHome       := "https://www.maths.uwa.edu.au/Members/reichard",
    PostalAddress := Concatenation( [
                       "Sven Reichard\n",
                       "School of Mathematics and Statistics\n",
                       "The University of Western Australia\n",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [["GAPDoc", ">= 0.99"], ["Forms", ">=1.2.2"], 
                          ["Orb",">=2.0"], ["GenSS",">=0.9"], 
			  ["GRAPE",">=4.3"]],
